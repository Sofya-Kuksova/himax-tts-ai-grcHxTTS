...
TfLiteStatus ComparisonsPrepare(TfLiteContext* context, TfLiteNode* node) {
  ...
  if (input1->type == kTfLiteInt8) {
    ...
    int32_t input1_multiplier, input2_multiplier;
    int input1_shift, input2_shift;
    
    QuantizeMultiplier(static_cast<double>(input1->params.scale), &input1_multiplier, &input1_shift);
    QuantizeMultiplier(static_cast<double>(input2->params.scale), &input2_multiplier, &input2_shift);
